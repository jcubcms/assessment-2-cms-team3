...
function education_u3a_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );
	$saturation         = absint( apply_filters( 'education_u3a_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.education_u3a-front-page) .entry-title,
...
.colors-custom .education_u3a-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.education_u3a-front-page .panel-content .recent-posts article,
...
.colors-custom.education_u3a-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'education_u3a_custom_colors_css', $css, $hue, $saturation );
}
